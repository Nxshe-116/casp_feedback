...
var OverlayRef = class {
  ...
  _renders = new import_rxjs12.Subject();
  _afterRenderRef;
  ...
  _detachContentWhenEmpty() {
    this._ngZone.runOutsideAngular(() => {
      const subscription = this._renders.pipe((0, import_operators8.takeUntil)((0, import_rxjs12.merge)(this._attachments, this._detachments))).subscribe(() => {
...
//# sourceMappingURL=chunk-ZEV6LNBM.js.map
